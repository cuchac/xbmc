...
const std::string pszBase58 = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
...
std::string CBase58::EncodeBase58(const ByteArray& bytes)
{
  return EncodeImpl(bytes.data(), bytes.data() + bytes.size());
}

bool CBase58::DecodeBase58(const std::string& base58String, ByteArray& bytes)
{
