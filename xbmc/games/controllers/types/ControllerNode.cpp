...
void CControllerNode::SetPortAddress(std::string address)
{
  m_portAddress = std::move(address);
}

void CControllerNode::SetControllerAddress(std::string address)
{
  m_controllerAddress = std::move(address);
}
