...
void CGUIListItemLayout::AddControl(CGUIControl* control)
{
  m_group.AddControl(control);
}

void CGUIListItemLayout::WalkControls(std::function<void(CGUIControl*)> callback)
{
  m_group.WalkControls(callback);
}
